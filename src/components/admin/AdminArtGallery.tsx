...
export const AdminArtGallery = ({ data, refetch }: AdminEntryProps) => {
  ...
  // api calls
  const { mutateAsync: updateEntry } = api.guide.patchArtGallery.useMutation();
  const { mutateAsync: deleteEntry } = api.guide.deleteArtGallery.useMutation();
