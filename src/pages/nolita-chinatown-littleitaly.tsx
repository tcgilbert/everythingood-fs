          ...
          <div className="overflow-hidden rounded-t-lg bg-white shadow">
            <div className="px-4 py-5 sm:p-6">
              <p className="text-center font-eb text-lg">
                ...
                cap or a guide telling you to go to Lombardi’s Pizza or a love
                letter to the San Gennaro Festival or a map of the best brick
                walls to film Tiktok outfit videos in front of.
              ...
              <p className="text-center font-eb text-lg">
                ...
                might be because I don’t know it. But it could also be that I
              ...
              <p className="text-center font-eb text-lg">
                ...
                residents in Manhattan’s Chinatown. They do fantastic work
                keeping the incredibly important culture of Manhattan’s
              ...
              <p className="text-center font-eb text-lg">
                ...
                neighborhoods in one guide?!?! Well, listen up, buddy! It’s
                because they’re small and they stack up perfectly on top of each
                other to form one normal-sized neighborhood. I’m talking about
                the space marked on the map above, bound by Houston St. on the
                North, Bowery on the East, Worth St. on the South, and Lafayette
                St. on the West. We should also note that Chinatown spreads into
                Tribeca and the Lower East Side, so the Chinatown spots on this
                guide only include those not in the other two neighborhoods.
              </p>
              <div className="py-3" />
              <p className="text-center font-eb text-lg">
